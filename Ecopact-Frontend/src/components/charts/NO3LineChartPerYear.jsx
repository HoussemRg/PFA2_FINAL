...
const NO3LineChartPerYear = (props) => {
    const {NO3DataPerYear}=useSelector(state => state.data);
    const months=['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
       ...
       const data=calculateAvg(NO3DataPerYear);
       const finalData={
...
export default NO3LineChartPerYear
